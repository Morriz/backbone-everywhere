var require = function(a, b) {
  var c = require.resolve(a, b || "/"),d = require.modules[c];
  if (!d)throw new Error("Failed to resolve module " + a + ", tried " + c);
  var e = d._cached ? d._cached : d();
  return e
},__require = require;
require.paths = [],require.modules = {},require.extensions = [".js",".coffee"],require.resolve = function() {
  var a = {assert:!0,events:!0,fs:!0,path:!0,vm:!0};
  return function(b, c) {
    function k(a) {
      var b;
    ...
    function i(a) {
      ...
      if (require.modules[b]) {
        var c = require.modules[b](),e = c.browserify;
        if (typeof e == "object" && e.main) {
          var f = h(d.resolve(a, e.main));
          if (f)return f
        } else if (typeof e == "string") {
          var f = h(d.resolve(a, e));
          if (f)return f
        } else if (c.main) {
          var f = h(d.resolve(a, c.main));
          if (f)return f
        }
      }
      return h(a + "/index")
    ...
    c || (c = "/");
    if (a[b])return b;
    var d = require.modules.path(),e = c || ".";
    if (b.match(/^(?:\.\.?\/|\/)/)) {
  ...
  var c = require.modules.path(),d = null;
  try {
  ...
  var f = c.dirname(d);
  Object.keys(require.modules).forEach(function(a) {
    if (a.slice(0, f.length + 1) === f + "/") {
      var c = a.slice(f.length);
      require.modules[b + c] = require.modules[f + c]
    } else a === f && (require.modules[b] = require.modules[f])
  })
},typeof process == "undefined" && (process = {}),process.nextTick || (process.nextTick = function(a) {
  setTimeout(a, 0)
  ...
  var a = {exports:{}},b = a.exports,c = ".",d = "path",e = function(a) {
    return __require(a, ".")
  };
  e.resolve = function(a) {
    return __require.resolve(name, ".")
  },e.modules = __require.modules,__require.modules.path._cached = a.exports,function() {
    function a(a, b) {
      var c = 0;
    ...
    b.resolve = function() {
      var b = "",c = !1;
      for (var d = arguments.length; d >= -1 && !c; d--) {
        var e = d >= 0 ? arguments[d] : process.cwd();
        if (typeof e != "string" || !e)continue;
        b = e + "/" + b,c = e.charAt(0) === "/"
      }
      b = a(b.split("/").filter(function(a) {
        return!!a
      }), !c).join("/");
      return(c ? "/" : "") + b || "."
    },b.normalize = function(b) {
      var c = b.charAt(0) === "/",d = b.slice(-1) === "/";
      b = a(b.split("/").filter(function(a) {
        return!!a
      }), !c).join("/"),!b && !c && (b = "."),b && d && (b += "/");
      return(c ? "/" : "") + b
      ...
      return b.normalize(a.filter(
        function(a, b) {
          return a && typeof a == "string"
        }).join("/"))
    },b.dirname = function(a) {
      var b = c.exec(a)[1] || "",d = !1;
  ...
  }.call(a.exports),__require.modules.path._cached = a.exports;
  return a.exports
},require.modules["/node_modules/jquery/package.json"] = function() {
  var a = {exports:{}},b = a.exports,c = "/node_modules/jquery",d = "/node_modules/jquery/package.json",e = function(a) {
    return __require(a, "/node_modules/jquery")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/node_modules/jquery")
  },e.modules = __require.modules,__require.modules["/node_modules/jquery/package.json"]._cached = a.exports,function() {
    a.exports = {name:"jquery",description:"jQuery: The Write Less, Do More, JavaScript Library",url:"jquery.com",keywords:["util","dom","jquery"],author:"John Resig <jeresig@gmail.com>",contributors:[],dependencies:{jsdom:">=0.2.0",htmlparser:">= 1.7.3"},lib:"lib",main:"./dist/node-jquery.js",version:"1.6.2"}
  }.call(a.exports),__require.modules["/node_modules/jquery/package.json"]._cached = a.exports;
  return a.exports
},require.modules["/node_modules/jquery/dist/node-jquery.js"] = function() {
  var a = {exports:{}},b = a.exports,c = "/node_modules/jquery/dist",d = "/node_modules/jquery/dist/node-jquery.js",e = function(a) {
    return __require(a, "/node_modules/jquery/dist")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/node_modules/jquery/dist")
  },e.modules = __require.modules,__require.modules["/node_modules/jquery/dist/node-jquery.js"]._cached = a.exports,function() {
    (function() {
      function b(a) {
        var b,c,d;
        a = a || e("jsdom").jsdom().createWindow(),b = a.location || {},c = a.navigator || {userAgent:"Node.js"},"function" != typeof a.XMLHttpRequest && "object" != typeof a.XMLHttpRequest && "function" != typeof a.ActiveXObject && (a.XMLHttpRequest = function() {
        }),function(a, b) {
          function cv(a) {
          ...
          f.extend({cache:{},uuid:0,expando:"jQuery" + (f.fn.jquery + Math.random()).replace(/\D/g, ""),noData:{embed:!0,object:"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000",applet:!0},hasData:function(a) {
            ...
            if (!!f.acceptData(a)) {
              ...
              return c === "events" && !i[c] ? i[g] && i[g].events : h ? i[f.camelCase(c)] || i[c] : i
            }
          ...
          f.fn.extend({attr:function(a, b) {
            ...
            return v && f.nodeName(a, "button") ? v.get(a, b) : b in a ? a.value : null
          },set:function(a, b, c) {
          ...
          f.fn.extend({find:function(a) {
            ...
            return!a || typeof a == "string" ? f.inArray(this[0], a ? f(a) : this.parent().children()) : f.inArray(a.jquery ? a[0] : a, this)
          },add:function(a, b) {
      ...
      "undefined" == typeof a && (a = {}),a.exports = b("undefined" == typeof window ? undefined : window),a.exports.create = b,"undefined" == typeof provide && (provide = function() {
      }),provide("jquery")
    })()
  }.call(a.exports),__require.modules["/node_modules/jquery/dist/node-jquery.js"]._cached = a.exports;
  return a.exports
},require.modules["/node_modules/underscore/package.json"] = function() {
  var a = {exports:{}},b = a.exports,c = "/node_modules/underscore",d = "/node_modules/underscore/package.json",e = function(a) {
    return __require(a, "/node_modules/underscore")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/node_modules/underscore")
  },e.modules = __require.modules,__require.modules["/node_modules/underscore/package.json"]._cached = a.exports,function() {
  ...
  }.call(a.exports),__require.modules["/node_modules/underscore/package.json"]._cached = a.exports;
  return a.exports
},require.modules["/node_modules/underscore/underscore.js"] = function() {
  var a = {exports:{}},b = a.exports,c = "/node_modules/underscore",d = "/node_modules/underscore/underscore.js",e = function(a) {
    return __require(a, "/node_modules/underscore")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/node_modules/underscore")
  },e.modules = __require.modules,__require.modules["/node_modules/underscore/underscore.js"]._cached = a.exports,function() {
    (function() {
      var b = this,c = b._,d = {},e = Array.prototype,f = Object.prototype,g = Function.prototype,h = e.slice,i = e.unshift,j = f.toString,k = f.hasOwnProperty,l = e.forEach,m = e.map,n = e.reduce,o = e.reduceRight,p = e.filter,q = e.every,r = e.some,s = e.indexOf,t = e.lastIndexOf,u = Array.isArray,v = Object.keys,w = g.bind,x = function(a) {
        return new C(a)
      };
      typeof a != "undefined" && a.exports ? (a.exports = x,x._ = x) : b._ = x,x.VERSION = "1.1.7";
      var y = x.each = x.forEach = function(a, b, c) {
        if (a != null)if (l && a.forEach === l)a.forEach(b, c); else if (a.length === +a.length) {
      ...
      x.include = x.contains = function(a, b) {
        ...
        var a = h.call(arguments),b = x.max(x.pluck(a, "length")),c = Array(b);
      ...
      x.uniqueId = function(a) {
        var b = B++;
        return a ? a + b : b
      },x.templateSettings = {evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g},x.template = function(a, b) {
        var c = x.templateSettings,d = "var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('" + a.replace(/\\/g, "\\\\").replace(/'/g, "\\'").replace(c.interpolate,
          function(a, b) {
            return"'," + b.replace(/\\'/g, "'") + ",'"
  ...
  }.call(a.exports),__require.modules["/node_modules/underscore/underscore.js"]._cached = a.exports;
  return a.exports
},require.modules["/node_modules/backbone/package.json"] = function() {
  var a = {exports:{}},b = a.exports,c = "/node_modules/backbone",d = "/node_modules/backbone/package.json",e = function(a) {
    return __require(a, "/node_modules/backbone")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/node_modules/backbone")
  },e.modules = __require.modules,__require.modules["/node_modules/backbone/package.json"]._cached = a.exports,function() {
    a.exports = {name:"backbone",description:"Give your JS App some Backbone with Models, Views, Collections, and Events.",url:"http://documentcloud.github.com/backbone/",keywords:["util","functional","server","client","browser"],author:"Jeremy Ashkenas <jeremy@documentcloud.org>",contributors:[],dependencies:{underscore:">=1.1.2"},lib:".",main:"backbone.js",version:"0.5.3"}
  }.call(a.exports),__require.modules["/node_modules/backbone/package.json"]._cached = a.exports;
  return a.exports
},require.modules["/node_modules/backbone/backbone.js"] = function() {
  var a = {exports:{}},b = a.exports,c = "/node_modules/backbone",d = "/node_modules/backbone/backbone.js",e = function(a) {
    return __require(a, "/node_modules/backbone")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/node_modules/backbone")
  },e.modules = __require.modules,__require.modules["/node_modules/backbone/backbone.js"]._cached = a.exports,function() {
    (function() {
      var a = this,c = a.Backbone,d;
      typeof b != "undefined" ? d = b : d = a.Backbone = {},d.VERSION = "0.5.3";
      var f = a._;
      !f && typeof e != "undefined" && (f = e("underscore")._);
      var g = a.jQuery || a.Zepto || e("jquery");
      d.noConflict = function() {
        a.Backbone = c;
        return this
      },d.emulateHTTP = !1,d.emulateJSON = !1,d.Events = {bind:function(a, b, c) {
        ...
        this.attributes = {},this._escapedAttributes = {},this.cid = f.uniqueId("c"),this.set(a, {silent:!0}),this._changed = !1,this._previousAttributes = f.clone(this.attributes),b && b.collection && (this.collection = b.collection),this.initialize(a, b)
      },f.extend(d.Model.prototype, d.Events, {_previousAttributes:null,_changed:!1,idAttribute:"id",initialize:function() {
      },toJSON:function() {
        ...
        for (var g in a) {
          var h = a[g];
          f.isEqual(c[g], h) || (c[g] = h,delete d[g],this._changed = !0,b.silent || this.trigger("change:" + g, this, h, b))
        }
        !e && !b.silent && this._changed && this.change(b),this._changing = !1;
        return this
      },unset:function(a, b) {
        ...
        return(this.sync || d.sync).call(this, "delete", this, a)
      },url:function() {
        ...
        for (var d in a)f.isEqual(b[d], a[d]) || (c = c || {},c[d] = a[d]);
        return c
      },previous:function(a) {
        ...
        b || (b = {}),b.comparator && (this.comparator = b.comparator),f.bindAll(this, "_onModelEvent", "_removeReference"),this._reset(),a && this.reset(a, {silent:!0}),this.initialize.apply(this, arguments)
      },f.extend(d.Collection.prototype, d.Events, {model:d.Model,initialize:function() {
      },toJSON:function() {
        ...
        if (f.isArray(a))for (var c = 0,d = a.length; c < d; c++)this._remove(a[c], b); else this._remove(a, b);
        return this
      },get:function(a) {
        ...
        a || (a = []),b || (b = {}),this.each(this._removeReference),this._reset(),this.add(a, {silent:!0}),b.silent || this.trigger("reset", this, b);
        return this
      },fetch:function(a) {
        a || (a = {});
        var b = this,c = a.success;
        ...
        if (a instanceof d.Model)a.collection || (a.collection = this); else {
          var c = a;
          a = new this.model(c, {collection:this}),a.validate && !a._performValidation(c, b) && (a = !1)
        }
        return a
      },_add:function(a, b) {
        b || (b = {}),a = this._prepareModel(a, b);
      ...
      var i = /:([\w\d]+)/g,j = /\*([\w\d]+)/g,k = /[-[\]{}()+?.,\\^$|#\s]/g;
      f.extend(d.Router.prototype, d.Events, {initialize:function() {
      },route:function(a, b, c) {
        d.history || (d.history = new d.History),f.isRegExp(a) || (a = this._routeToRegExp(a)),d.history.route(a, f.bind(function(d) {
      ...
      var l = /^#*/,m = /msie [\w.]+/,n = !1;
      f.extend(d.History.prototype, {interval:50,getFragment:function(a, b) {
        ...
        return decodeURIComponent(a.replace(l, ""))
      },start:function(a) {
        if (n)throw new Error("Backbone.history has already been started");
        this.options = f.extend({}, {root:"/"}, this.options, a),this._wantsPushState = !!this.options.pushState,this._hasPushState = !!(this.options.pushState && window.history && window.history.pushState);
        var b = this.getFragment(),c = document.documentMode,d = m.exec(navigator.userAgent.toLowerCase()) && (!c || c <= 7);
        d && (this.iframe = g('<iframe src="javascript:0" tabindex="-1" />').hide().appendTo("body")[0].contentWindow,this.navigate(b)),this._hasPushState ? g(window).bind("popstate", this.checkUrl) : "onhashchange"in window && !d ? g(window).bind("hashchange", this.checkUrl) : setInterval(this.checkUrl, this.interval),this.fragment = b,n = !0;
        ...
        this.cid = f.uniqueId("view"),this._configure(a || {}),this._ensureElement(),this.delegateEvents(),this.initialize.apply(this, arguments)
      };
      var o = function(a) {
        return g(a, this.el)
      },p = /^(\S+)\s*(.*)$/,q = ["model","collection","el","id","attributes","className","tagName"];
      f.extend(d.View.prototype, d.Events, {tagName:"div",$:o,initialize:function() {
      },render:function() {
        return this
      },remove:function() {
        g(this.el).remove();
        ...
        b && g(d).attr(b),c && g(d).html(c);
        return d
      },delegateEvents:function(a) {
        if (!!a || !!(a = this.events)) {
          f.isFunction(a) && (a = a.call(this)),g(this.el).unbind(".delegateEvents" + this.cid);
          for (var b in a) {
            var c = this[a[b]];
            if (!c)throw new Error('Event "' + a[b] + '" does not exist');
            var d = b.match(p),e = d[1],h = d[2];
            c = f.bind(c, this),e += ".delegateEvents" + this.cid,h === "" ? g(this.el).bind(e, c) : g(this.el).delegate(h, e, c)
          }
        }
        ...
        } else f.isString(this.el) && (this.el = g(this.el).get(0))
      }});
      var r = function(a, b) {
        var c = u(this, a, b);
      ...
      d.Model.extend = d.Collection.extend = d.Router.extend = d.View.extend = r;
      var s = {create:"POST",update:"PUT","delete":"DELETE",read:"GET"};
      d.sync = function(a, b, c) {
        var e = s[a],h = f.extend({type:e,dataType:"json"}, c);
        h.url || (h.url = v(b) || w()),!h.data && b && (a == "create" || a == "update") && (h.contentType = "application/json",h.data = JSON.stringify(b.toJSON())),d.emulateJSON && (h.contentType = "application/x-www-form-urlencoded",h.data = h.data ? {model:h.data} : {}),d.emulateHTTP && (e === "PUT" || e === "DELETE") && (d.emulateJSON && (h.data._method = e),h.type = "POST",h.beforeSend = function(a) {
          a.setRequestHeader("X-HTTP-Method-Override", e)
        }),h.type !== "GET" && !d.emulateJSON && (h.processData = !1);
        return g.ajax(h)
      };
      var t = function() {
      },u = function(a, b, c) {
        ...
        },f.extend(d, a),t.prototype = a.prototype,d.prototype = new t,b && f.extend(d.prototype, b),c && f.extend(d, c),d.prototype.constructor = d,d.__super__ = a.prototype;
        return d
      },v = function(a) {
        return!a || !a.url ? null : f.isFunction(a.url) ? a.url() : a.url
      },w = function() {
  ...
  }.call(a.exports),__require.modules["/node_modules/backbone/backbone.js"]._cached = a.exports;
  return a.exports
},require.modules["/node_modules/ejs/package.json"] = function() {
  var a = {exports:{}},b = a.exports,c = "/node_modules/ejs",d = "/node_modules/ejs/package.json",e = function(a) {
    return __require(a, "/node_modules/ejs")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/node_modules/ejs")
  },e.modules = __require.modules,__require.modules["/node_modules/ejs/package.json"]._cached = a.exports,function() {
    a.exports = {name:"ejs",description:"Embedded JavaScript templates",version:"0.4.3",author:"TJ Holowaychuk <tj@vision-media.ca>",keywords:["template","engine","ejs"],main:"./lib/ejs.js"}
  }.call(a.exports),__require.modules["/node_modules/ejs/package.json"]._cached = a.exports;
  return a.exports
},require.modules["/node_modules/ejs/lib/ejs.js"] = function() {
  var a = {exports:{}},b = a.exports,c = "/node_modules/ejs/lib",d = "/node_modules/ejs/lib/ejs.js",e = function(a) {
    return __require(a, "/node_modules/ejs/lib")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/node_modules/ejs/lib")
  },e.modules = __require.modules,__require.modules["/node_modules/ejs/lib/ejs.js"]._cached = a.exports,function() {
    function g(a, b, c, d) {
      var e = b.split("\n"),f = Math.max(d - 3, 0),g = Math.min(e.length, d + 3),h = e.slice(f, g).map(
        function(a, b) {
          var c = b + f + 1;
          return(c == d ? " >> " : "    ") + c + "| " + a
        }).join("\n");
      a.path = c,a.message = (c || "ejs") + ":" + d + "\n" + h + "\n\n" + a.message;
      throw a
    }
    ...
    function f(a) {
      return a.substr(1).split("|").reduce(function(a, b) {
        ...
        e && (e = ", " + e);
        return"filters." + d + "(" + a + e + ")"
      })
    }

    var a = e("./utils");
    b.version = "0.4.3";
    var c = b.filters = e("./filters"),d = {};
    b.clearCache = function() {
      d = {}
    };
    var h = b.parse = function(a, c) {
      var c = c || {},d = c.open || b.open || "<%",e = c.close || b.close || "%>",g = ["var buf = [];","\nwith (locals) {","\n  buf.push('"],h = 1;
      for (var i = 0,j = a.length; i < j; ++i)if (a.slice(i, d.length + i) == d) {
        i += d.length;
        var k,l,m = "__stack.lineno=" + h;
        switch (a[i]) {
          case"=":
            k = "', escape((" + m + ", ",l = ")), '",++i;
            break;
        ...
        while (~(q = o.indexOf("\n", q)))q++,h++;
        o[0] == ":" && (o = f(o)),g.push(k, o, l),i += n - p + e.length - 1
      } else a[i] == "\\" ? g.push("\\\\") : a[i] == "'" ? g.push("\\'") : a[i] == "\r" ? g.push(" ") : a[i] == "\n" ? (g.push("\\n"),h++) : g.push(a[i]);
      g.push("');\n}\nreturn buf.join('');");
      return g.join("")
    },i = b.compile = function(d, e) {
      e = e || {};
      var f = JSON.stringify(d),h = e.filename ? JSON.stringify(e.filename) : "undefined";
      d = ["var __stack = { lineno: 1, input: " + f + ", filename: " + h + " };",g.toString(),"try {",b.parse(d, e),"} catch (err) {","  rethrow(err, __stack.input, __stack.filename, __stack.lineno);","}"].join("\n"),e.debug && console.log(d);
      var i = new Function("locals, filters, escape", d);
      return function(b) {
        return i.call(this, b, c, a.escape)
      }
    };
    b.render = function(a, b) {
      var c,b = b || {};
      if (b.cache)if (b.filename)c = d[b.filename] || (d[b.filename] = i(a, b)); else throw new Error('"cache" option requires "filename".'); else c = i(a, b);
      return c.call(b.scope, b.locals || {})
    },e.extensions ? e.extensions[".ejs"] = function(a, b) {
      source = e("fs").readFileSync(b, "utf-8"),a._compile(i(source, {}), b)
    } : e.registerExtension && e.registerExtension(".ejs", function(a) {
      return i(a, {})
    })
  }.call(a.exports),__require.modules["/node_modules/ejs/lib/ejs.js"]._cached = a.exports;
  return a.exports
},require.modules["/node_modules/ejs/lib/utils.js"] = function() {
  var a = {exports:{}},b = a.exports,c = "/node_modules/ejs/lib",d = "/node_modules/ejs/lib/utils.js",e = function(a) {
    return __require(a, "/node_modules/ejs/lib")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/node_modules/ejs/lib")
  },e.modules = __require.modules,__require.modules["/node_modules/ejs/lib/utils.js"]._cached = a.exports,function() {
    b.escape = function(a) {
      return String(a).replace(/&(?!\w+;)/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;")
    }
  }.call(a.exports),__require.modules["/node_modules/ejs/lib/utils.js"]._cached = a.exports;
  return a.exports
},require.modules["/node_modules/ejs/lib/filters.js"] = function() {
  var a = {exports:{}},b = a.exports,c = "/node_modules/ejs/lib",d = "/node_modules/ejs/lib/filters.js",e = function(a) {
    return __require(a, "/node_modules/ejs/lib")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/node_modules/ejs/lib")
  },e.modules = __require.modules,__require.modules["/node_modules/ejs/lib/filters.js"]._cached = a.exports,function() {
    b.first = function(a) {
      return a[0]
    },b.last = function(a) {
      return a[a.length - 1]
  ...
  }.call(a.exports),__require.modules["/node_modules/ejs/lib/filters.js"]._cached = a.exports;
  return a.exports
},require.modules["/app.js"] = function() {
  var a = {exports:{}},b = a.exports,c = "/",d = "/app.js",e = function(a) {
    return __require(a, "/")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/")
  },e.modules = __require.modules,__require.modules["/app.js"]._cached = a.exports,function() {
    var b = e("./routers/index"),c = e("./backbone-modified"),d = function(a) {
      a = a || {};
      for (var d in b)new b[d];
      a.pushState = !0,c.history.start(a)
    };
    a.exports = d
  }.call(a.exports),__require.modules["/app.js"]._cached = a.exports;
  return a.exports
},require.modules["/routers/index.js"] = function() {
  var a = {exports:{}},b = a.exports,c = "/routers",d = "/routers/index.js",e = function(a) {
    return __require(a, "/routers")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/routers")
  },e.modules = __require.modules,__require.modules["/routers/index.js"]._cached = a.exports,function() {
    typeof a == "undefined" && (a = {}),a.exports = {Song:e("./SongRouter")}
  }.call(a.exports),__require.modules["/routers/index.js"]._cached = a.exports;
  return a.exports
},require.modules["/routers/SongRouter.js"] = function() {
  var a = {exports:{}},b = a.exports,c = "/routers",d = "/routers/SongRouter.js",e = function(a) {
    return __require(a, "/routers")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/routers")
  },e.modules = __require.modules,__require.modules["/routers/SongRouter.js"]._cached = a.exports,function() {
    var b = e("underscore"),c = e("../views/index"),d = e("../models/index"),f = e("../backbone-modified"),g = f.View;
    a.exports = f.Router.extend({routes:{"":"songList",songs:"songList","songs/:id":"song"},songList:function() {
      if (!this.songListView) {
        var a = new d.SongCollection;
        ONCLIENT && a.subscribe(),this.songListView = new c.SongList({collection:a}),a.fetch({success:g.getViewFunc(this.songListView)}),g.registerLayout(this.songListView)
      } else g.getViewFunc(this.songListView)()
    },song:function(a) {
      if (this.songListView)var b = !0,e = this.songListView.collection.get(a); else var b = !1,e = new d.Song({id:a});
      ONCLIENT && ((!this.songView || this.songView.model.id != a) && e.subscribe(),this.songView && this.songView.model.id != a && this.songView.model.unsubscribe()),this.songView ? e !== this.songView.model && this.songView.initModel(e) : (this.songView = new c.Song({model:e}),g.registerLayout(this.songView)),b ? g.getViewFunc(this.songView)() : e.fetch({success:g.getViewFunc(this.songView)})
    }})
  }.call(a.exports),__require.modules["/routers/SongRouter.js"]._cached = a.exports;
  return a.exports
},require.modules["/views/index.js"] = function() {
  var a = {exports:{}},b = a.exports,c = "/views",d = "/views/index.js",e = function(a) {
    return __require(a, "/views")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/views")
  },e.modules = __require.modules,__require.modules["/views/index.js"]._cached = a.exports,function() {
    typeof a == "undefined" && (a = {}),a.exports = {SongList:e("./SongListView"),SongListItem:e("./SongListItemView"),Song:e("./SongView")}
  }.call(a.exports),__require.modules["/views/index.js"]._cached = a.exports;
  return a.exports
},require.modules["/views/SongListView.js"] = function() {
  var a = {exports:{}},b = a.exports,c = "/views",d = "/views/SongListView.js",e = function(a) {
    return __require(a, "/views")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/views")
  },e.modules = __require.modules,__require.modules["/views/SongListView.js"]._cached = a.exports,function() {
    var b = e("underscore"),c = e("jquery"),d = e("../backbone-modified");
    a.exports = d.View.extend({el:"#songlist-view",templateHtml:templates.songlist,statsTemplateHtml:templates.songlistStats,events:{"keypress #new-song":"createOnEnter","keyup #new-song":"showTooltip","click .song-clear a":"clearCompleted"},initialize:function() {
      this.statsTemplate = this.renderEngine.compile(this.statsTemplateHtml);
      var a = this.template(this.templateHtml);
      this.$el.html(a),this.$("#song-list").html(""),this.$("#songlist-stats").html(""),this.input = this.$("#new-song"),this.collection.bind("add", this.addOne, this),this.collection.bind("reset", this.addAll, this),this.collection.bind("all", this.render, this),this.trigger("attach")
    },render:function() {
      var a = this.statsTemplate({total:this.collection.length,published:this.collection.published().length,remaining:this.collection.remaining().length});
      this.$("#songlist-stats").html(a)
    },addOne:function(a) {
      var b = e("../views/index").SongListItem,c = (new b({model:a})).render().el;
      this.$("#song-list").append(c)
    },addAll:function() {
      this.$("#song-list").html(""),this.collection.each(b.bind(this.addOne, this))
    },newAttributes:function() {
      return{title:this.input.val(),order:this.collection.nextOrder(),published:!1}
    },createOnEnter:function(a) {
      a.keyCode == 13 && (this.collection.create(this.newAttributes()),this.input.val(""))
    },clearCompleted:function() {
      b.each(this.collection.published(), function(a) {
        a.destroy()
      });
      return!1
    },showTooltip:function(a) {
      var c = this.$(".ui-tooltip-top"),d = this.input.val();
      c.fadeOut(),this.tooltipTimeout && clearTimeout(this.tooltipTimeout);
      if (d != "" && d != this.input.attr("placeholder")) {
        var e = function() {
          c.show().fadeIn()
        };
        this.tooltipTimeout = b.delay(e, 1e3)
      }
    }})
  }.call(a.exports),__require.modules["/views/SongListView.js"]._cached = a.exports;
  return a.exports
},require.modules["/backbone-modified.js"] = function() {
  var a = {exports:{}},b = a.exports,c = "/",d = "/backbone-modified.js",e = function(a) {
    return __require(a, "/")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/")
  },e.modules = __require.modules,__require.modules["/backbone-modified.js"]._cached = a.exports,function() {
    var b = e("underscore"),c = e("jquery"),d = e("backbone"),f = e("ejs");
    d.View = e("./backbone-urlhandler");
    var g = d.View.prototype;
    BackboneViewExtend = d.View.extend,d.View = function(a) {
      this.cid = b.uniqueId("view"),this._configure(a || {}),this._ensureElement(),this.events = this.events || {},b.extend(this.events, d.View.prototype.events),this.delegateEvents(),this._initialize.apply(this, arguments),this.initialize.apply(this, arguments)
    },d.View.prototype = g,d.View.extend = BackboneViewExtend,d.View = d.View.extend({renderEngine:f,_initialize:function(a) {
      this.templateHtml && !b.isFunction(this.template) && (this.template = this.renderEngine.compile(this.templateHtml))
    },show:function() {
      ...
      if (!this.el) {
        var a = this.attributes || {};
        this.id && (a.id = this.id),this.className && (a["class"] = this.className),this.el = this.make(this.tagName, a)
      } else b.isString(this.el) && (this.el = c(this.el, document).get(0));
      this.$el = c(this.el, document)
    }}),d.View.layouts = [],d.View.registerLayout = function(a) {
      d.View.layouts.push(a)
    },d.View.getViewFunc = function(a) {
      return function() {
        d.View.onlyShowLayout(a),ONSERVER && sendFullHtmlToClient()
      }
    },d.View.onlyShowLayout = function(a) {
      c(".layout", document).css("display", "none"),a.show()
    },e("./backbone.redis"),d.sync = b.sync,a.exports = d
  }.call(a.exports),__require.modules["/backbone-modified.js"]._cached = a.exports;
  return a.exports
},require.modules["/backbone-urlhandler.js"] = function() {
  var a = {exports:{}},b = a.exports,c = "/",d = "/backbone-urlhandler.js",e = function(a) {
    return __require(a, "/")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/")
  },e.modules = __require.modules,__require.modules["/backbone-urlhandler.js"]._cached = a.exports,function() {
    var b = e("underscore"),c = e("backbone");
    view = c.View,view.prototype.events = {"click a.noscroll":"routeClickNoScroll","click a:not(.noscroll)":"routeClick"},view.prototype.routeClickNoScroll = function(a) {
      return this.routeClick(a, !0)
    },view.prototype.routeClick = function(a, c) {
      if (b.size(window.currentKeys))return!0;
      var d = this.normalizeHREF($(a.currentTarget).get(0).getAttribute("href", 2));
      return d ? this.route(d, c) : !0
    },view.prototype.normalizeHREF = function(a) {
      var b = document.documentMode,c = $.browser.msie && (!b || b <= 7);
      if (c) {
        var d = /^https?:\/\/([^/]+)(\/.*)$/.exec(a);
        if (!d || d < 3)return!1;
        var a = d.pop(),e = d.pop();
        if (window.location.host != e)return!1;
        a.indexOf("/#") === 0 && (a = a.substr(1))
      }
      return a
    },view.prototype.route = function(a, d) {
      if (a === "#" || a === "/#!")return!1;
      var e = this;
      if (a.charAt(0) === "/") {
        a = a.substr(1);
        var f = b.any(c.history.handlers, function(b) {
          if (b.route.test(a)) {
            c.history.navigate(a),d || e.scrollTop(),b.callback(a);
            return!0
          }
        });
        return!f
      ...
      if ($("body").scrollTop())$("body").animate({scrollTop:0}); else if ($("html").scrollTop()) {
        $("html").animate({scrollTop:0});
        return
      }
    },a.exports = c.View
  }.call(a.exports),__require.modules["/backbone-urlhandler.js"]._cached = a.exports;
  return a.exports
},require.modules["/backbone.redis.js"] = function() {
  var a = {exports:{}},b = a.exports,c = "/",d = "/backbone.redis.js",e = function(a) {
    return __require(a, "/")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/")
  },e.modules = __require.modules,__require.modules["/backbone.redis.js"]._cached = a.exports,function() {
    (function() {
      var c = this,d,f,g = "message",h = c.Store || (c.Store = {}),i = c._;
      !i && typeof e != "undefined" && (i = e("underscore")._);
      var j = c.Backbone;
      !j && typeof e != "undefined" && (j = e("backbone"));
      var k = {},l = {},m = function(a) {
        ...
        k[b.channel] = a,l[b.channel] = {success:b.success,error:b.error}
      };
      d = {config:function(a, b) {
        a.io && (f = a.io),a.listener && (g = a.listener),f.on(g, function(a) {
          d.process(a)
        }),b && b()
      },process:function(a) {
        var b = a.model,c = a.options;
        if (!!c && !!c.method)switch (c.method) {
          case"published":
            d.published(a);
            break;
          case"subscribed":
      ...
      },subscribed:function(a) {
        var b = a.options;
        b.finished && b.finished(a)
      },unsubscribed:function(a) {
        var b = a.options;
        b.finished && b.finished(a)
      },published:function(a) {
        var b = a.options;
        if (!!b.method)switch (b.method) {
          case"create":
            d.created(a);
            break;
          case"read":
        ...
        var b = a.model,c = a.options,d = h[c.channel];
        d instanceof j.Model ? d.set(d.parse(b)) : d instanceof j.Collection && (d.get(b.id) || d.add(d.parse(b))),c.finished && c.finished(b)
      },read:function(a) {
        var b = a.model,c = a.options,d = c.channel,e = h[d] || m(d),f = l[d];
        e instanceof j.Model ? e.set(e.parse(b)) : e instanceof j.Collection && (i.isArray(b) ? e.reset(e.parse(b)) : e.get(b.id) || e.add(e.parse(b)));
        var g = e instanceof j.Collection ? e.models : e;
        f.success && f.success(g),c.finished && c.finished(b)
      },updated:function(a) {
        var b = a.model,c = a.options,d = h[c.channel];
        d.get(b.id) ? d.get(b.id).set(d.parse(b)) : d.set(d.parse(b)),c.finished && c.finished(b)
      },destroyed:function(a) {
        var b = a.model,c = a.options,d = h[c.channel];
        h[c.channel].remove(b) || delete h[c.channel],c.finished && c.finished(b)
      }},i.extend(j.Model.prototype, {publish:function(a, b) {
        if (!f)return a.error && a.error(503, c, a);
        var c = this;
        a || (a = {}),a.channel || (a.channel = c.getChannel()),a.method = "publish",a.type = c.type;
        var d = {model:c.toJSON(),options:a};
        f.emit(g, d, function(d) {
          a.silent || c.trigger("publish", c, a),b && b(d)
        });
        return this
      },getChannel:function() {
        var a = this.type || (this.collection ? this.collection.type : null);
        return this.type + (this.id ? ":" + this.id : "")
      }}),i.extend(j.Collection.prototype, {getChannel:function() {
        return this.type || (this.model && this.model.type ? this.model.type : null)
      }});
      var p = {connection:f,subscribe:function(a, b) {
        if (!f)return a.error && a.error(503, c, a);
        var c = this;
        a || (a = {}),a.channel || (a.channel = c.getChannel()),a.method = "subscribe",a.type = c.type;
        var d = {model:c.toJSON(),options:a};
        !h[a.channel] || a.override ? (h[a.channel] = c,f.emit(g, d, function(d) {
          a.silent || c.trigger("subscribe", c, a),b && b(d)
        })) : (a.silent || c.trigger("subscribe", c, a),b && b(response));
        return this
      },unsubscribe:function(a, b) {
        if (!f)return a.error && a.error(503, c, a);
        var c = this;
        a || (a = {}),a.channel || (a.channel = c.getChannel()),a.method = "unsubscribe";
        var d = {model:{},options:a};
        f.emit(g, d, function(d) {
          a.silent || c.trigger("unsubscribe", c, a),b && b(d)
        }),delete h[a.channel];
        return this
      }};
      i.mixin({sync:function(a, b, c) {
        if (!f)return c.error && c.error(503, b, c);
        b.attributes && b.attributes._id && delete b.attributes.id,c.type || (c.type = b.type || b.collection.type),c.channel || (c.channel = b.getChannel()),c.method || (c.method = a),o(b, c);
        var d = {model:b.toJSON(),options:c};
        if (a === "read") {
          var e = {};
          d.model.id && (e.id = d.model.id),d.model = e
        }
        f.emit(g, d)
      }}),i.extend(j.Model.prototype, p),i.extend(j.Collection.prototype, p),typeof b != "undefined" ? a.exports = d : c.core = d
    }).call(this)
  }.call(a.exports),__require.modules["/backbone.redis.js"]._cached = a.exports;
  return a.exports
},require.modules["/views/SongListItemView.js"] = function() {
  var a = {exports:{}},b = a.exports,c = "/views",d = "/views/SongListItemView.js",e = function(a) {
    return __require(a, "/views")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/views")
  },e.modules = __require.modules,__require.modules["/views/SongListItemView.js"]._cached = a.exports,function() {
    var b = e("underscore"),c = e("jquery"),d = e("../backbone-modified");
    a.exports = d.View.extend({tagName:"li",templateHtml:templates.songlistItem,events:{"click .check":"toggleActivated","dblclick div.song-content":"edit","click span.song-destroy":"remove","keypress .song-input":"updateOnEnter"},initialize:function() {
      this.model.bind("change", this.render, this),this.model.bind("destroy", this.remove, this),this.model.view = this
    },render:function() {
      this.$el.html(this.template(this.model.toJSON())),this._enrich();
      return this
    },_enrich:function() {
      this.input = this.$(".song-input"),this.input.bind("blur", b.bind(this.close, this))
    },toggleActivated:function() {
      this.model.toggle()
    },edit:function() {
      this.$el.addClass("editing"),this.input.focus()
    },close:function() {
      this.model.save({title:this.input.val()}),this.$el.removeClass("editing")
    },updateOnEnter:function(a) {
      a.keyCode == 13 && this.close()
    },remove:function() {
      this.model.destroy(),this.$el.remove()
    },clear:function() {
      this.model.clear()
    }})
  }.call(a.exports),__require.modules["/views/SongListItemView.js"]._cached = a.exports;
  return a.exports
},require.modules["/views/SongView.js"] = function() {
  var a = {exports:{}},b = a.exports,c = "/views",d = "/views/SongView.js",e = function(a) {
    return __require(a, "/views")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/views")
  },e.modules = __require.modules,__require.modules["/views/SongView.js"]._cached = a.exports,function() {
    var b = e("underscore"),c = e("jquery"),d = e("../backbone-modified");
    a.exports = d.View.extend({el:"#song-view",templateHtml:templates.song,events:{"dblclick div.song-content":"edit","click span.song-destroy":"clear","keypress .song-input":"updateOnEnter"},initialize:function() {
      this.initModel(),this.trigger("attach")
    },initModel:function(a) {
      this.model = a || this.model,this.model.bind("change", this.render, this),this.model.view = this,this.render()
    },render:function() {
      this.$el.html(this.template(this.model.toJSON())),this._enrich();
      return this
    },_enrich:function() {
  ...
  }.call(a.exports),__require.modules["/views/SongView.js"]._cached = a.exports;
  return a.exports
},require.modules["/models/index.js"] = function() {
  var a = {exports:{}},b = a.exports,c = "/models",d = "/models/index.js",e = function(a) {
    return __require(a, "/models")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/models")
  },e.modules = __require.modules,__require.modules["/models/index.js"]._cached = a.exports,function() {
    typeof a == "undefined" && (a = {}),a.exports = {Song:e("./SongModel"),SongCollection:e("./SongCollection")}
  }.call(a.exports),__require.modules["/models/index.js"]._cached = a.exports;
  return a.exports
},require.modules["/models/SongModel.js"] = function() {
  var a = {exports:{}},b = a.exports,c = "/models",d = "/models/SongModel.js",e = function(a) {
    return __require(a, "/models")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/models")
  },e.modules = __require.modules,__require.modules["/models/SongModel.js"]._cached = a.exports,function() {
    var b = e("../backbone-modified"),c = e("./SongCollection");
    a.exports = b.Model.extend({type:"songs",collection:new c,storage:"SongModel",defaults:{title:"empty title...",published:!1},initialize:function() {
      this.get("title") || this.set({title:this.defaults.title}),this.bind("remove", this._removeView, this),this.bind("destroy", this._removeView, this)
    },toggle:function() {
      this.save({published:!this.get("published")})
    },_removeView:function() {
      this.view && this.view.remove()
    }})
  }.call(a.exports),__require.modules["/models/SongModel.js"]._cached = a.exports;
  return a.exports
},require.modules["/models/SongCollection.js"] = function() {
  var a = {exports:{}},b = a.exports,c = "/models",d = "/models/SongCollection.js",e = function(a) {
    return __require(a, "/models")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/models")
  },e.modules = __require.modules,__require.modules["/models/SongCollection.js"]._cached = a.exports,function() {
    var b = e("../backbone-modified"),c = e("./SongModel");
    a.exports = b.Collection.extend({type:"songs",storage:"SongCollection",model:c,initialize:function() {
      this.model = e("./SongModel")
    },published:function() {
  ...
  }.call(a.exports),__require.modules["/models/SongCollection.js"]._cached = a.exports;
  return a.exports
},require.modules["/clientonly.js"] = function() {
  var a = {exports:{}},b = a.exports,c = "/",d = "/clientonly.js",e = function(a) {
    return __require(a, "/")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/")
  },e.modules = __require.modules,__require.modules["/clientonly.js"]._cached = a.exports,function() {
    templates = e("templates"),ONSERVER = !1,ONCLIENT = !ONSERVER,ifServerSendFullHtmlToClient = function() {
    };
    var a = e("./backbone.redis"),b = io.connect();
    a.config({io:b});
    var c = e("./app");
    $(document).ready(c)
  }.call(a.exports),__require.modules["/clientonly.js"]._cached = a.exports;
  return a.exports
},require.modules["/node_modules/templates"] = function() {
  var a = {exports:{}},b = a.exports,c = "/node_modules",d = "/node_modules/templates",e = function(a) {
    return __require(a, "/node_modules")
  };
  e.resolve = function(a) {
    return __require.resolve(name, "/node_modules")
  },e.modules = __require.modules,__require.modules["/node_modules/templates"]._cached = a.exports,function() {
    a.exports = {song:'<!-- Song View -->\n<div class="title">\n    <h1>Song Details</h1>\n</div>\n<div class="content">\n    <div id="song">\n        <div class="display">\n            <div class="song-content">\n                Title: <%= title %><br />\n                Checked: <%= published %><br />\n            </div>\n        </div>\n        <div class="edit">\n            <input class="song-input" type="text" value="<%= title %>" />\n        </div>\n    </div>\n    <div id="song-stats" class="song-stats">\n        <span class="song-count"><span class="number">1</span> <span class="word">item</span> left.</span>\n    </div>\n</div>\n',songlist:'<!-- SongList View -->\n<div class="title">\n    <h1>Song List</h1>\n</div>\n<div class="content">\n    <div id="create-song">\n        <input id="new-song" placeholder="Song title?" type="text" /><span class="ui-tooltip-top" style="display:none;">Press Enter to save as a new Song</span>\n    </div>\n    <div id="songs">\n        <ul id="song-list">\n            <li>\n                <div class="song published">\n                    <div class="display">\n                        <input class="check" type="checkbox" checked="checked"/>\n                        <div class="song-content">\n                            this one is checked\n                        </div>\n                        <span class="song-destroy"></span>\n                    </div>\n                    <div class="edit">\n                        <input class="song-input" type="text" value="" />\n                    </div>\n                </div>\n            </li>\n            <li>\n                <div class="song">\n                    <div class="display">\n                        <input class="check" type="checkbox"/>\n                        <div class="song-content">\n                            this one is not checked\n                        </div>\n                        <span class="song-destroy"></span>\n                    </div>\n                    <div class="edit">\n                        <input class="song-input" type="text" value="" />\n                    </div>\n                </div>\n            </li>\n        </ul>\n    </div>\n    <div id="songlist-stats" class="song-stats">\n        <span class="song-count"><span class="number">1</span> <span class="word">item</span> left.</span>\n        <span class="song-clear"><a href="#">Clear <span class="number-published">1</span> checked <span class="word-published">item</span></a></span>\n    </div>\n</div>\n',songlistItem:'<div class="song <%= published ? \'published\' : \'\' %>">\n    <div class="display">\n        <input class="check" type="checkbox"<%= published ? \'checked="checked"\' : \'\' %>/>\n        <div class="song-content">\n            <a href="/songs/<%= id %>"><%= title %></a>\n        </div>\n        <span class="song-destroy"></span>\n    </div>\n    <div class="edit">\n        <input class="song-input" type="text" value="<%= title %>" />\n    </div>\n</div>',songlistStats:'<% if (total) { %>\n    <span class="song-count">\n        <span class="number"><%= remaining %></span>\n        <span class="word"><%= remaining == 1 ? \'item\' : \'items\' %></span> left.\n    </span>\n<% } %>\n<% if (published) { %>\n    <span class="song-clear">\n        <a href="#">\n            Clear<span class="number-done"> <%= published %></span>\n            checked <span class="word-done"><%= published == 1 ? \'item\' : \'items\' %></span>\n        </a>\n    </span>\n<% } %>\n'}
  }.call(a.exports),__require.modules["/node_modules/templates"]._cached = a.exports;
  return a.exports
}